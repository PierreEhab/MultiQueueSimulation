...
namespace MultiQueueSimulation
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            textBox4.Text = Sim_System.Servers[Servers_ComboBox.SelectedIndex].Utilization.ToString();
            textBox5.Text = Sim_System.Servers[Servers_ComboBox.SelectedIndex].AverageServiceTime.ToString();
            textBox6.Text = Sim_System.Servers[Servers_ComboBox.SelectedIndex].IdleProbability.ToString();
        }
    }
}
